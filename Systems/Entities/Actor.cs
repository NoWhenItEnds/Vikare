...
namespace Vikare.Entities
{
    ...
    {
        /// <summary> Animation player that drives this actor's visual state. </summary>
        [ExportGroup("Nodes")]
        [Export] public AnimationPlayer AnimationPlayer { get; private set; } = null!;

        /// <summary> State machine governing this actor's behaviour; exposed via <see cref="IStateMachineAccess.Machine"/> for state transitions. </summary>
